...
else if (thisTime == LUNCH) console.log('체력 보충을 위한 잠을 잔다');
else if (thisTime == DINNER) console.log('이듬 영상 강의를 시청한다');
else if (thisTime == NIGHT) console.log('팀원들과 수업 내용을 공유한다.');
else if (thisTime == LATE_NIGHT || 
          thisTime == DAWN) console.log("꿈속에서 배웠던 코드를 생각한다.");
