...
// 난수
let random = Math.random() * 10; // 0 ~ 0.99999999999
...
let count = 0;
setInterval(() => {
  document.querySelector('.first').style.transform = `translate(${Math.sin(++count) * 10}px, ${Math.sin(++count) * -10}px)`
}, 100)
...
console.log(getRandomMinMax(10,20));
